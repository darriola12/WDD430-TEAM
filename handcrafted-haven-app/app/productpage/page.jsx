      ...
      <nav className="bg-white shadow-md py-4 px-6 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <ul className="flex space-x-6">
            ...
            <li>
              <Link href="/sellers" className="text-gray-700 hover:text-gray-900 transition duration-200">
                Sellers
              </Link>
            </li>
            <li>
              <Link href="/products" className="text-gray-700 hover:text-gray-900 transition duration-200">
                Products
              </Link>
            </li>
            <li>
              <Link href="/about" className="text-gray-700 hover:text-gray-900 transition duration-200">
                About Us
              </Link>
            </li>
          </ul>
